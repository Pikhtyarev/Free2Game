...
import { Grid, ImageList, ImageListItem, Typography, Button, LinearProgress, Box } from '@mui/material';
		...
		<Grid container spacing={4}>
			...
			{error && (
				<Box sx={{ m: 6 }}>
					...
					<Typography sx={{ fontSize: '2rem' }}>{error}</Typography>
				</Box>
			)}
